...
public interface SupplierService {
    ...
    ResponseEntity<ResponseModel> findSupplierBySupplierId(Long supplierID) throws SupplierException;
    ...
    ResponseEntity<ResponseModel> updateSupplier(RequestSupplierUpdate requestSupplierUpdate) throws SupplierException;
