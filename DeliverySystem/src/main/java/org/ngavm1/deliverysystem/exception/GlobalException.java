...
public class GlobalException {
    ...
    public ResponseEntity<ResponseModel> handleSupplierException(SupplierException e) {
        ResponseModel responseModel = new ResponseModel(HttpStatus.BAD_REQUEST.value(),
                "A error occur with supplier exception: " + e.getMessage(), null);
    ...
    public ResponseEntity<ResponseModel> handleEmployeeException(EmployeeException e) {
        ResponseModel responseModel = new ResponseModel(HttpStatus.BAD_REQUEST.value(),
                "A error occur with employee exception: " + e.getMessage(), null);
        return ResponseEntity.badRequest().body(responseModel);
    }
    ...
    public ResponseEntity<ResponseModel> handleOrderException(OrderException e) {
        ResponseModel responseModel = new ResponseModel(HttpStatus.BAD_REQUEST.value(),
                "A error occur with order exception: " + e.getMessage(), null);
        return ResponseEntity.badRequest().body(responseModel);
    }
    ...
    public ResponseEntity<ResponseModel> handleException(Exception e) {
        ResponseModel responseModel = new ResponseModel(HttpStatus.INTERNAL_SERVER_ERROR.value(),
                "A error occur with exception: " + e.getMessage(), null);
        return ResponseEntity.badRequest().body(responseModel);
    }
}